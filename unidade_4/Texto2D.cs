namespace CG_N4
{
    ...
    //     public static readonly Texto2D Instance = new Texto2D();
    //     
    ...
    //         using (Stream stream = assembly.GetManifestResourceStream("CG_N4.Resources.FreeSans.ttf"))
    //         {
    ...
    //         Face face = new Face(lib, fontBytes, 0);
    ...
    //     }
    //
    //     public void RenderizarTexto(string text, float x, float y, float scale, Vector2 dir)
    //     {
